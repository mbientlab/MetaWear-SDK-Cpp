...
def setup_libmetawear(libmetawear):
    ...
    libmetawear.mbl_mw_datasignal_subscribe.argtypes= [c_void_p, FnDataPtr]
    ...
    libmetawear.mbl_mw_datasignal_log.argtypes= [c_void_p, FnDataPtr, FnVoid]

    libmetawear.mbl_mw_datasignal_remove_logger.restype= None
    libmetawear.mbl_mw_datasignal_remove_logger.argtypes= [c_void_p]
    ...
    libmetawear.mbl_mw_event_end_record.argtypes= [c_void_p, FnVoid]
    ...
    libmetawear.mbl_mw_metawearboard_initialize.argtypes= [c_void_p, FnVoid]
    ...
    libmetawear.mbl_mw_metawearboard_lookup_module.argtypes= [c_void_p, c_ubyte]
    ...
    libmetawear.mbl_mw_settings_read_battery_state.restype= None
    libmetawear.mbl_mw_settings_read_battery_state.argtypes= [c_void_p]

    libmetawear.mbl_mw_timer_create.restype= None
    libmetawear.mbl_mw_timer_create.argtypes= [c_void_p, c_uint, c_ushort, c_ubyte, FnVoidPtr]

    libmetawear.mbl_mw_timer_create_indefinite.restype= None
    libmetawear.mbl_mw_timer_create_indefinite.argtypes= [c_void_p, c_uint, c_ubyte, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_accumulator_create.argtypes= [c_void_p, FnVoidPtr]

    libmetawear.mbl_mw_dataprocessor_accumulator_create_size.restype= c_int
    libmetawear.mbl_mw_dataprocessor_accumulator_create_size.argtypes= [c_void_p, c_ubyte, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_average_create.argtypes= [c_void_p, c_ubyte, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_buffer_create.argtypes= [c_void_p, FnVoidPtr]

    libmetawear.mbl_mw_dataprocessor_comparator_create.restype= c_int
    libmetawear.mbl_mw_dataprocessor_comparator_create.argtypes= [c_void_p, c_int, c_float, FnVoidPtr]

    libmetawear.mbl_mw_dataprocessor_comparator_create_signed.restype= c_int
    libmetawear.mbl_mw_dataprocessor_comparator_create_signed.argtypes= [c_void_p, c_int, c_float, FnVoidPtr]

    libmetawear.mbl_mw_dataprocessor_comparator_create_unsigned.restype= c_int
    libmetawear.mbl_mw_dataprocessor_comparator_create_unsigned.argtypes= [c_void_p, c_int, c_float, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_counter_create.argtypes= [c_void_p, FnVoidPtr]

    libmetawear.mbl_mw_dataprocessor_counter_create_size.restype= c_int
    libmetawear.mbl_mw_dataprocessor_counter_create_size.argtypes= [c_void_p, c_ubyte, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_read_state.restype= None
    libmetawear.mbl_mw_dataprocessor_read_state.argtypes= [c_void_p]
    ...
    libmetawear.mbl_mw_dataprocessor_delta_create.argtypes= [c_void_p, c_int, c_float, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_math_create.argtypes= [c_void_p, c_int, c_float, FnVoidPtr]

    libmetawear.mbl_mw_dataprocessor_math_create_signed.restype= c_int
    libmetawear.mbl_mw_dataprocessor_math_create_signed.argtypes= [c_void_p, c_int, c_float, FnVoidPtr]

    libmetawear.mbl_mw_dataprocessor_math_create_unsigned.restype= c_int
    libmetawear.mbl_mw_dataprocessor_math_create_unsigned.argtypes= [c_void_p, c_int, c_float, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_passthrough_create.argtypes= [c_void_p, c_int, c_ushort, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_pulse_create.argtypes= [c_void_p, c_int, c_float, c_ushort, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_rms_create.argtypes= [c_void_p, FnVoidPtr]

    libmetawear.mbl_mw_dataprocessor_rss_create.restype= c_int
    libmetawear.mbl_mw_dataprocessor_rss_create.argtypes= [c_void_p, FnVoidPtr]

    libmetawear.mbl_mw_dataprocessor_sample_create.restype= c_int
    libmetawear.mbl_mw_dataprocessor_sample_create.argtypes= [c_void_p, c_ubyte, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_threshold_create.argtypes= [c_void_p, c_int, c_float, c_float, FnVoidPtr]
    ...
    libmetawear.mbl_mw_dataprocessor_time_create.argtypes= [c_void_p, c_int, c_uint, FnVoidPtr]
    ...
    libmetawear.mbl_mw_acc_set_odr.restype= None
    libmetawear.mbl_mw_acc_set_odr.argtypes= [c_void_p, c_float]

    libmetawear.mbl_mw_acc_set_range.restype= None
    ...
    libmetawear.mbl_mw_cd_tcs34725_read_adc.restype= None
    libmetawear.mbl_mw_cd_tcs34725_read_adc.argtypes= [c_void_p]
    ...
    libmetawear.mbl_mw_gpio_read_analog_input.restype= None
    libmetawear.mbl_mw_gpio_read_analog_input.argtypes= [c_void_p, c_ubyte, c_int]

    libmetawear.mbl_mw_gpio_set_pull_mode.restype= None
    libmetawear.mbl_mw_gpio_set_pull_mode.argtypes= [c_void_p, c_ubyte, c_int]

    libmetawear.mbl_mw_gpio_read_digital_input.restype= None
    libmetawear.mbl_mw_gpio_read_digital_input.argtypes= [c_void_p, c_ubyte]
    ...
    libmetawear.mbl_mw_humidity_bme280_read_percentage.restype= None
    libmetawear.mbl_mw_humidity_bme280_read_percentage.argtypes= [c_void_p]
    ...
    libmetawear.mbl_mw_i2c_read.restype= None
    libmetawear.mbl_mw_i2c_read.argtypes= [c_void_p, c_ubyte, c_ubyte, c_ubyte, c_ubyte]
    ...
    libmetawear.mbl_mw_multi_chnl_temp_read_temperature.restype= None
    libmetawear.mbl_mw_multi_chnl_temp_read_temperature.argtypes= [c_void_p, c_ubyte]
    ...
    libmetawear.mbl_mw_proximity_tsl2671_read_adc.restype= None
    libmetawear.mbl_mw_proximity_tsl2671_read_adc.argtypes= [c_void_p]
