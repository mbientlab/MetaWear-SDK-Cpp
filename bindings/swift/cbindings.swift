...
public let MBL_MW_MODULE_ACC_TYPE_BMI270 = 4
public let MBL_MW_SETTINGS_POWER_STATUS_UNSUPPORTED = -1
public let MBL_MW_STATUS_OK = 0
public let MBL_MW_ADDRESS_TYPE_PRIVATE_NON_RESOLVABLE = 3
public let MBL_MW_MODULE_GYRO_TYPE_BMI160 = 0
