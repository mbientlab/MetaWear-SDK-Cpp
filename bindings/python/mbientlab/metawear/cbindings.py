...
class Data(Structure):
    ...
    def __eq__(self, other):
        return (self.epoch == other.epoch and self.value == other.value and self.type_id == other.type_id and self.length == other.length)

    def __neq__(self, other):
        return not self.__eq__(other)

    def __repr__(self):
        return "{epoch : %d, value : %d, type_id : %d, length : %d}" % (self.epoch, self.value, self.type_id, self.length)

    def __deepcopy__(self, memo):
        return Data(epoch = self.epoch, value = self.value, type_id = self.type_id, length = self.length)

FnVoid_DataP = CFUNCTYPE(None, POINTER(Data))
FnVoid_VoidP_VoidP_UInt = CFUNCTYPE(None, c_void_p, c_void_p, c_uint)
...
class BtleAddress(Structure):
    ...
    def __repr__(self):
        return "{address_type : %d, address : %d}" % (self.address_type, self.address)

    def __deepcopy__(self, memo):
        return BtleAddress(address_type = self.address_type, address = self.address)
...
FnVoid_UInt_UInt = CFUNCTYPE(None, c_uint, c_uint)
FnVoid_UByte_Long_UByteP_UByte = CFUNCTYPE(None, c_ubyte, c_longlong, POINTER(c_ubyte), c_ubyte)
class LogDownloadHandler(Structure):
    ...
    def __eq__(self, other):
        return (self.received_progress_update == other.received_progress_update and self.received_unknown_entry == other.received_unknown_entry and self.received_unhandled_entry == other.received_unhandled_entry)

    def __neq__(self, other):
        return not self.__eq__(other)

    def __repr__(self):
        return "{received_progress_update : %d, received_unknown_entry : %d, received_unhandled_entry : %d}" % (self.received_progress_update, self.received_unknown_entry, self.received_unhandled_entry)

    def __deepcopy__(self, memo):
        return LogDownloadHandler(received_progress_update = self.received_progress_update, received_unknown_entry = self.received_unknown_entry, received_unhandled_entry = self.received_unhandled_entry)
...
FnVoid_Int = CFUNCTYPE(None, c_int)
FnVoid_charP = CFUNCTYPE(None, c_void_p)
class DfuDelegate(Structure):
    ...
    def __eq__(self, other):
        return (self.on_dfu_started == other.on_dfu_started and self.on_dfu_cancelled == other.on_dfu_cancelled and self.on_transfer_percentage == other.on_transfer_percentage and self.on_successful_file_transferred == other.on_successful_file_transferred and self.on_error == other.on_error)

    def __neq__(self, other):
        return not self.__eq__(other)

    def __repr__(self):
        return "{on_dfu_started : %d, on_dfu_cancelled : %d, on_transfer_percentage : %d, on_successful_file_transferred : %d, on_error : %d}" % (self.on_dfu_started, self.on_dfu_cancelled, self.on_transfer_percentage, self.on_successful_file_transferred, self.on_error)

    def __deepcopy__(self, memo):
        return DfuDelegate(on_dfu_started = self.on_dfu_started, on_dfu_cancelled = self.on_dfu_cancelled, on_transfer_percentage = self.on_transfer_percentage, on_successful_file_transferred = self.on_successful_file_transferred, on_error = self.on_error)
...
FnVoid_VoidP_GattCharWriteType_GattCharP_UByteP_UByte = CFUNCTYPE(None, c_void_p, c_int, POINTER(GattChar), POINTER(c_ubyte), c_ubyte)
FnVoid_VoidP_GattCharP_FnIntVoidPtrArray = CFUNCTYPE(None, c_void_p, POINTER(GattChar), FnInt_VoidP_UByteP_UByte)
FnVoid_VoidP_GattCharP_FnIntVoidPtrArray_FnVoidVoidPtrInt = CFUNCTYPE(None, c_void_p, POINTER(GattChar), FnInt_VoidP_UByteP_UByte, FnVoid_VoidP_Int)
FnVoid_VoidP_FnVoidVoidPtrInt = CFUNCTYPE(None, c_void_p, FnVoid_VoidP_Int)
class BtleConnection(Structure):
    _fields_ = [
        ...
        ("on_disconnect" , FnVoid_VoidP_FnVoidVoidPtrInt)
    ]

    def __eq__(self, other):
        return (self.write_gatt_char == other.write_gatt_char and self.read_gatt_char == other.read_gatt_char and self.enable_notifications == other.enable_notifications and self.on_disconnect == other.on_disconnect)

    def __neq__(self, other):
        return not self.__eq__(other)

    def __repr__(self):
        return "{write_gatt_char : %d, read_gatt_char : %d, enable_notifications : %d, on_disconnect : %d}" % (self.write_gatt_char, self.read_gatt_char, self.enable_notifications, self.on_disconnect)

    def __deepcopy__(self, memo):
        return BtleConnection(write_gatt_char = self.write_gatt_char, read_gatt_char = self.read_gatt_char, enable_notifications = self.enable_notifications, on_disconnect = self.on_disconnect)
...
def init_libmetawear(libmetawear):
    ...
    libmetawear.mbl_mw_sensor_fusion_read_config.argtypes = [c_void_p, FnVoid_VoidP_Int]
    ...
    libmetawear.mbl_mw_metawearboard_get_model_name.restype = c_void_p
    ...
    libmetawear.mbl_mw_dataprocessor_multi_comparator_create_signed.argtypes = [c_void_p, c_int, c_int, POINTER(c_float), c_ubyte, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_connection_notify_char_changed.argtypes = [c_void_p, POINTER(c_ubyte), c_ubyte]
    ...
    libmetawear.mbl_mw_metawearboard_char_read.argtypes = [c_void_p, POINTER(GattChar), POINTER(c_ubyte), c_ubyte]

    libmetawear.mbl_mw_metawearboard_create_anonymous_datasignals.restype = None
    libmetawear.mbl_mw_metawearboard_create_anonymous_datasignals.argtypes = [c_void_p, FnVoid_VoidP_VoidP_UInt]

    libmetawear.mbl_mw_dataprocessor_accounter_create.restype = c_int
    libmetawear.mbl_mw_dataprocessor_accounter_create.argtypes = [c_void_p, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_metawearboard_notify_char_changed.argtypes = [c_void_p, POINTER(c_ubyte), c_ubyte]
    ...
    libmetawear.mbl_mw_dataprocessor_highpass_create.argtypes = [c_void_p, c_ubyte, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_logger_subscribe.argtypes = [c_void_p, FnVoid_DataP]
    ...
    libmetawear.mbl_mw_macro_end_record.argtypes = [c_void_p, FnVoid_VoidP_Int]
    ...
    libmetawear.mbl_mw_dataprocessor_math_create_signed.argtypes = [c_void_p, c_int, c_float, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_metawearboard_initialize.argtypes = [c_void_p, FnVoid_VoidP_Int]
    ...
    libmetawear.mbl_mw_dataprocessor_threshold_create.argtypes = [c_void_p, c_int, c_float, c_float, FnVoid_VoidP]

    libmetawear.mbl_mw_timer_create_indefinite.restype = None
    libmetawear.mbl_mw_timer_create_indefinite.argtypes = [c_void_p, c_uint, c_ubyte, FnVoid_VoidP]

    libmetawear.mbl_mw_anonymous_datasignal_get_identifier.restype = c_void_p
    ...
    libmetawear.mbl_mw_dataprocessor_comparator_create_signed.argtypes = [c_void_p, c_int, c_float, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_debug_read_stack_overflow_state.argtypes = [c_void_p, FnVoid_DataP]
    ...
    libmetawear.mbl_mw_datasignal_subscribe.argtypes = [c_void_p, FnVoid_DataP]

    libmetawear.mbl_mw_timer_create.restype = None
    libmetawear.mbl_mw_timer_create.argtypes = [c_void_p, c_uint, c_ushort, c_ubyte, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_anonymous_datasignal_subscribe.argtypes = [c_void_p, FnVoid_DataP]
    ...
    libmetawear.mbl_mw_metawearboard_perform_dfu.argtypes = [c_void_p, POINTER(DfuDelegate), c_void_p]
    ...
    libmetawear.mbl_mw_logger_generate_identifier.restype = c_void_p
    ...
    libmetawear.mbl_mw_dataprocessor_comparator_create.argtypes = [c_void_p, c_int, c_float, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_time_create.argtypes = [c_void_p, c_int, c_uint, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_passthrough_create.argtypes = [c_void_p, c_int, c_ushort, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_counter_create.argtypes = [c_void_p, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_sample_create.argtypes = [c_void_p, c_ubyte, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_buffer_create.argtypes = [c_void_p, FnVoid_VoidP]

    libmetawear.mbl_mw_dataprocessor_delta_create.restype = c_int
    libmetawear.mbl_mw_dataprocessor_delta_create.argtypes = [c_void_p, c_int, c_float, FnVoid_VoidP]

    libmetawear.mbl_mw_dataprocessor_pulse_create.restype = c_int
    libmetawear.mbl_mw_dataprocessor_pulse_create.argtypes = [c_void_p, c_int, c_float, c_ushort, FnVoid_VoidP]

    libmetawear.mbl_mw_dataprocessor_rms_create.restype = c_int
    libmetawear.mbl_mw_dataprocessor_rms_create.argtypes = [c_void_p, FnVoid_VoidP]

    libmetawear.mbl_mw_dataprocessor_rss_create.restype = c_int
    libmetawear.mbl_mw_dataprocessor_rss_create.argtypes = [c_void_p, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_accumulator_create.argtypes = [c_void_p, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_accumulator_create_size.argtypes = [c_void_p, c_ubyte, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_comparator_create_unsigned.argtypes = [c_void_p, c_int, c_float, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_multi_comparator_create.argtypes = [c_void_p, c_int, c_int, POINTER(c_float), c_ubyte, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_multi_comparator_create_unsigned.argtypes = [c_void_p, c_int, c_int, POINTER(c_float), c_ubyte, FnVoid_VoidP]

    libmetawear.mbl_mw_dataprocessor_math_create.restype = c_int
    libmetawear.mbl_mw_dataprocessor_math_create.argtypes = [c_void_p, c_int, c_float, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_counter_create_size.argtypes = [c_void_p, c_ubyte, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_acc_read_config.argtypes = [c_void_p, FnVoid_VoidP_Int]

    libmetawear.mbl_mw_dataprocessor_math_create_unsigned.restype = c_int
    libmetawear.mbl_mw_dataprocessor_math_create_unsigned.argtypes = [c_void_p, c_int, c_float, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_connection_char_read.argtypes = [c_void_p, POINTER(GattChar), POINTER(c_ubyte), c_ubyte]
    ...
    libmetawear.mbl_mw_gyro_bmi160_read_config.argtypes = [c_void_p, FnVoid_VoidP_Int]
    ...
    libmetawear.mbl_mw_datasignal_log.argtypes = [c_void_p, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_packer_create.argtypes = [c_void_p, c_ubyte, FnVoid_VoidP]

    libmetawear.mbl_mw_dataprocessor_average_create.restype = c_int
    libmetawear.mbl_mw_dataprocessor_average_create.argtypes = [c_void_p, c_ubyte, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_dataprocessor_lowpass_create.argtypes = [c_void_p, c_ubyte, FnVoid_VoidP]
    ...
    libmetawear.mbl_mw_debug_read_schedule_queue_usage.argtypes = [c_void_p, FnVoid_DataP]

    libmetawear.mbl_mw_event_end_record.restype = None
    libmetawear.mbl_mw_event_end_record.argtypes = [c_void_p, FnVoid_VoidP_Int]
