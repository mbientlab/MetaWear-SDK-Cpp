...
class TestDebug(TestMetaWearBase):
    ...
    def test_handle_overflow_state(self):
        ...
        self.libmetawear.mbl_mw_debug_read_stack_overflow_state(self.board, self.sensor_data_handler)
    ...
    def test_handle_schedule_queue_state(self):
        ...
        self.libmetawear.mbl_mw_debug_read_schedule_queue_usage(self.board, self.sensor_data_handler)
